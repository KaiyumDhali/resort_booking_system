...
//        ProductComplain::create($request->all());
    ...
    public function productComplainListSearch($category_id, $subcategory_id, $product_id, $status, $pdf)
    {
        ...
        if ($pdf == "pdfurl") {
            ...
            // $pdf = PDF::loadView('admin.pdf.products_complain_list_pdf',  $data);
            // $dompdf = $pdf->getDomPDF();
            // $dompdf->getCanvas()->get_cpdf()->addJavascript("this.print();");

            //$canvas = $dompdf->getCanvas();
            // $canvas->page_script(function ($pageNumber, $pageCount, $canvas) {
            //     $js = "this.print(true);";
            //     $canvas->get_cpdf()->addJavaScript($js);
            // });
            // $canvas->get_cpdf()->addJavascript("this.print();");
            return view('admin.pdf.products_complain_list_pdf', compact(['productComplainLists', 'data']));
