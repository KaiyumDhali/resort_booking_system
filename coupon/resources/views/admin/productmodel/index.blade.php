...
<main class="page-content">
    <div class="container">
        <div class="page-header">
            <h1 class="page-header__title">Product Model Name/Number</h1>
        </div>
...
<!--                        <div class="col col-lg-auto">
                        ...
                        <div class="col-auto">
                            <a class="button-add button-add--blue" href="{{ route('productmodels.create') }}"><span class="button-add__icon">
        ...
        <div class="table-wrapper">
            <div class="table-wrapper__content table-products table-collapse scrollbar-thin scrollbar-visible" data-simplebar>
                <table class="table table--lines" id="brandTable">
                    <thead class="table__header">
                        <tr class="table__header-row">
                            <th class="table__th-sort"><span class="align-middle">Model Name/Number</span><span class="sort sort--down"></span>
                            </th>
                            <th class="table__th-sort"><span class="align-middle">Model Code</span><span class="sort sort--down"></span>
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr class="table__row">
                            <td class="table__td">{{$productmodel->model_name}}</td>
                            <td class="table__td">{{$productmodel->model_code}}</td>
                            <td class="table__td"><span>{{ $productmodel->status==1?'Active':'Disabled' }}</span>
                            </td>
                            <td class="table__td"><span><a href="{{ route('productmodels.edit', $productmodel->id) }}"><span class="dropdown-items__link-icon">
...
$('#brandTable').DataTable(dataTableOptions);
