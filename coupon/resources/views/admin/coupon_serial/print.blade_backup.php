    ...
    <div class="container">
        @for ($i = 1; $i <= $product_serial_qty; $i++)
            <div class="row" style="text-align:center;">
                <div class="col-12">
                    <div class="print" style="font-size: 8px; margin-top: 10px;">
                        {{ $product_serials->product->product_name }}
                    </div>
                    <div class=""
                        style="text-align: center; display: inline-block; margin-bottom:0; padding-bottom: 0;">
                        {!! DNS1D::getBarcodeHTML($product_serials->product_code, 'C128', 1, 20, 'black', false, 0.5) !!}
                    </div>
                    <div class="print" style="font-size: 8px; margin-top: 0; padding-top: 0;">
                        {{ $product_serials->product_serial }}
                    </div>
                    @php
