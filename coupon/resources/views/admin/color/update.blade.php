        ...
        <main class="page-content">
            <div class="container container--flex">
                <div class="page-header">
                    <h1 class="page-header__title">Add Color</h1>
                </div>
                <div class="card add-product card--content-center">
                    <div class="card__wrapper">
                        <div class="">
                                <form class="add-product__form" action="{{ route('colors.update', $color->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                <div class="">
                                        ...
                                        <div class="">
                                            <div class="col-12 form-group form-group--lg">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control" type="text" name="color_name" placeholder="" value="{{$color->color_name}}" required>
                                                </div>
                                            </div>
