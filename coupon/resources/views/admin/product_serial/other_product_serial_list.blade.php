    ...
    <main class="page-content">
        <div class="container">
            <div class="page-header">
                <h1 class="page-header__title">Other Product Serials</h1>
            </div>
            <div class="toolbox">
                <div class="toolbox__row row gutter-bottom-xs">
                    ...
                    <div class="toolbox__left col-12 col-lg">
                        <div class="toolbox__left-row row row--xs gutter-bottom-xs">
                            <div class="form-group form-group--inline col-4">
                                <label class="form-label">Product</label>
                                <div class="input-group input-group--white input-group--append">
                                    <select class="input input--select" id="product_id" name="product_id" required>
                                        <option class="dropdown-menu__item active" value="0">--Select Product--
                                        </option>
                        ...
                        <div class="toolbox__right-row row row--xs flex-nowrap">
                            <div class="col-auto">
                                <a class="button-add button-add--blue" title="Add Product New Serial"
                                    href="{{ route('other_product_serial_add') }}">
                ...
                <div class="table-wrapper__content table-products table-collapse scrollbar-thin scrollbar-visible"
                    ...
                    <table class="table table--lines" id="productSerialsTable">
                        ...
                        <tbody id='tbody'>
                            ...
                            @foreach ($otherProductSerials as $otherProductSerial)
                                <tr>
                                    <td>{{ $otherProductSerial->id }}</td>
                                    <td>{{ $otherProductSerial->otherproduct->product_name }}</td>
                                    <td>{{ $otherProductSerial->product_code }}</td>
                                    <td>{{ $otherProductSerial->product_serial }}</td>
                                    <td>{{ $otherProductSerial->created_at }}</td>
                                    <td>{{ $otherProductSerial->status }}</td>
                                    <td>
                                        <a data-bs-toggle="modal" title="Print Barcode & QR Code"
                                            data-bs-target="#kt_modal_new_card" data-all='{{ $otherProductSerial->product_serial }}'
                                            onclick='viewModel(this)'>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <form class="add-product__form" id="printQuantityForm" action="{{ route('other_rangeproductserialcode') }}"
    ...
    <div class="modal fade" id="productPrintQuantity" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <!--begin::Modal body-->
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form class="add-product__form" id="productPrintQuantityForm" action="{{ route('other_productserialcode') }}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal__body">
                            <div class="modal__container">
                                <div class="row">
                                    <div class="col-12 form-group form-group--lg">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type="text" name="product_serial" value="{{ $otherProductSerial->product_serial }}"
                                                value="">
                                        </div>
                                    </div>
                                    <div class="col-12 form-group form-group--lg">
    ...
    <script type="text/javascript">
        ...
        function viewModel(element) {
            ...
            try {
                ...
                const productPrintSerialId = allData.product_serial;
                ...
                $('#productPrintQuantity').find('input[name="product_serial"]').val(productPrintSerialId);
