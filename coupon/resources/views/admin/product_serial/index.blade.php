                            ...
                            <div class="form-group form-group--inline col-12">
                                ...
                                <div class="input-group input-group--white input-group--append">
                                    <select class="input input--select" id="category_id" name="category_id" required>
                                        <option class="dropdown-menu__item active" value="0">--Select Category--
                                        </option>
                                        @foreach ($allCategories as $key => $value)
                                            <option class="dropdown-menu__item" value="{{ $key }}">
                                                {{ $value }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group form-group--inline col-12">
                                ...
                                <div class="input-group input-group--white input-group--append">
                                    <select class="input input--select" id="subcategory_id" name="subcategory_id" required>
                                        <option class="dropdown-menu__item active" value="0">--Select Sub Category--
                                        </option>
                    ...
                    <div class="toolbox__left col-12 col-lg">
                        <div class="toolbox__left-row row row--xs gutter-bottom-xs">
                            <div class="form-group form-group--inline col-12">
                                ...
                                <div class="input-group input-group--white input-group--append">
                                    <select class="input input--select" id="print_status" name="print_status" required>
                                        <option class="dropdown-menu__item active" value="0" selected>--All Print
                                            Status--</option>
                        ...
                        <div class="toolbox__right-row row row--xs flex-nowrap">
                            <div class="col-auto">
                                <a class="button-add button-add--blue" title="Add Product New Serial"
                                    href="{{ route('productserials.create') }}">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <form class="add-product__form" id="printQuantityForm" action="{{ route('rangeserialcodeprint') }}"
    ...
    <div class="modal fade" id="productPrintQuantity" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <!--begin::Modal body-->
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <form class="add-product__form" id="productPrintQuantityForm" action="{{ route('serialcodeprint') }}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="modal__body">
                            <div class="modal__container">
                                <div class="row">
                                    <div class="col-12 form-group form-group--lg">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type="text" name="product_serial"
                                                value="" readonly>
                                        </div>
                                    </div>
                                    <div class="col-12 form-group form-group--lg">
