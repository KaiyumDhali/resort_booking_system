            ...
            <div class="toolbox__row row gutter-bottom-xs">
                ...
                <div class="toolbox__right col-12 col-lg-auto">
                    <div class="toolbox__right-row row row--xs flex-nowrap">
                        ...
                        <div class="col-auto">
                            <a class="button-add button-add--blue" title="Add New Product" href="{{ route('productserials.create') }}"><span
                        ...
                        <div class="col-auto">
                            <a data-bs-toggle="modal" title="Print Barcode & QR Code With Range" data-bs-target="#rangeprintQuantity" 
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form class="add-product__form" id="printQuantityForm2" action="{{ route('rangeserialcodeprint') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('POST')
                    <div class="modal__body">
                        <div class="modal__container">
...
//        const productData = JSON.parse(button.getAttribute('data-productPrint'));
        ...
        const serialId = productData.product_serial;
        ...
        console.log(printFormAction);
        
        $('#printQuantity').find('#printQuantityForm').attr('action', printFormAction);
        
        
        $('#printQuantity').find('#productserialid').text(productData.product_serial_id);
        $('#printQuantity').find('#productname').text(productData.product_name);
        $('#printQuantity').find('#productcode').text(productData.product_serial);
...
//        setTimeout(function(){
//            window.location.href = '{{-- route("productserials.index") --}}';
//        },5000);

    }
        // JavaScript code to redirect after a delay
...
//            console.log(data);
            ...
            if (data.length > 0) {
                $.each(data, function(key, value) {
                    ...
                    let downloadLink = `<a data-bs-toggle="modal" title="Print Barcode & QR Code" data-bs-target="#kt_modal_new_card" data-all='${alldata}' 
