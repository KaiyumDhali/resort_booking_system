                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="col-12 form-group form-group--lg">
                                                ...
                                                <p>
                                                    {!! DNS1D::getBarcodeSVG("$product_serials->product_code", 'C128',2,50,'black',true) !!}

                                                </p>
                                                <p>
                                                    P-{{ $product_serials->product_serial }}
                                                </p>
                                                <p>
                                                    {!! QrCode::backgroundColor(255,225,225, 0)->generate(url('/findproduct') . '/' . $product_serials->product_serial); !!}
