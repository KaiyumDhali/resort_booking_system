...
<main class="page-content">
    <div class="container container--flex">
        <div class="page-header">
            <h1 class="page-header__title">Other Product Update</h1>
        </div>
        <div class="card add-product card--content-center">
            <div class="card__wrapper">
                <div class="">
                    ...
                    {{-- <form class="add-product__form" action="{{ route('other_product_edit', $other_product->id) }}" method="post" enctype="multipart/form-data"> --}}
                    <form class="add-product__form" action="{{ route('other_product_update', $other_product->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        <div class="">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="col-12 form-group form-group--lg">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type="text" name="product_code" id="product_code" placeholder="" value="{{$other_product->product_code}}" required>
                                        </div>
                                        @if ($errors->any())
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="col-12 form-group form-group--lg">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type="text" name="product_name" id="product_name" placeholder="" value="{{$other_product->product_name}}" required>
                                        </div>
                                    </div>
                                </div>
