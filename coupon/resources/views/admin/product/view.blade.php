                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="add-product__thumb swiper-slide">
                                                @if($product_image->image_path !== null)
                                                    <img class="add-product__thumb-image swiper-lazy" src="{{ asset($product_image->image_path) }}" srcset="{{ asset($product_image->image_path) }} 2x" alt="Product Image" />
                                                @endif                                                
                                ...
                                <div class="add-product__gallery">
                                    <div class="add-product__gallery-slider swiper-container">
                                        <div class="swiper-wrapper">
                                            @foreach($product->productimage as $product_image)
                                                @if ($product_image->image_path !== null)
                                                    <a class="add-product__gallery-slide swiper-slide js-lightbox-link" href="{{ asset($product_image->image_path) }}" data-pswp-srcset="{{ asset($product_image->image_path) }} 2x" data-title="{{$product->product_name}}" data-cropped="true"
                                                       target="_blank">
                                                            <img class="add-product__gallery-image" src="{{ asset($product_image->image_path) }}" srcset="{{ asset($product_image->image_path) }} 2x" alt="Product Image" />
                                                    </a>
                                              @endif 
                                            @endforeach
                                        </div>
...
<!--                                    <div class="col-12 form-group form-group--lg">
                                    ...
                                    {{--!! QrCode::size(100)->generate(Request::url('http://nrbtelecom.com/saffron_jusal/public/index.php')); !!--}}
...
<!--                                    <div class="col-12 form-group form-group--lg">
                                        ...
                                        <p>Color: <?= $product->color->color_name ?? "No color"; ?></p>
                                        <p>Model: <?= $product->productmodel->model_name ?? "No Model/Number"; ?></p>
