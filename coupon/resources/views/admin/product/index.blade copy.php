                        ...
                        <div class="col col-lg-auto">
                            <form class="toolbox__search" method="GET">
                                <!--                                <div class="input-group input-group--white input-group--prepend">
                                                                    ...
                                                                    <input class="input" id="search" name="search" type="text" placeholder="Search product">
                                                                </div>-->
                            </form>
                        </div>
                        <div class="col-auto">
                ...
                <table class="table table--lines" id="productTable">
                    ...
                    <tbody id='tbody'>
                        ...
                        <tr class="table__row">
                            ...
                            <td class="table__td">
                                <?= $product->productmodel->model_code.'-'.$product->productmodel->model_name ?? "No Model/Number"; ?>
