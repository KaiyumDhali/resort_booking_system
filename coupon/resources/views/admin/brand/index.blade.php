            ...
            <div class="toolbox__row row gutter-bottom-xs">
                ...
                <div class="toolbox__right col-12 col-lg-auto">
                    <div class="toolbox__right-row row row--xs flex-nowrap">
                        ...
                        <div class="col-auto">
                            <a class="button-add button-add--blue" href="{{ route('brands.create') }}"><span class="button-add__icon">
                ...
                <table class="table table--lines" id="brandTable">
                    <thead class="table__header">
                        <tr class="table__header-row">
                            ...
                            <th class="table__th-sort"><span class="align-middle">Brand Name</span><span class="sort sort--down"></span>
                            </th>
                            <th class="table__th-sort"><span class="align-middle">Brand Code</span><span class="sort sort--down"></span>
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr class="table__row">
                            <td class="table__td">{{$brand->id}}</td>
                            <td class="table__td">{{$brand->brand_name}}</td>
                            <td class="table__td">{{strtoupper($brand->brand_code)}}</td>
                            <td class="table__td"><span>{{ $brand->status==1?'Active':'Disabled' }}</span>
                            </td>
                            <td class="table__td"><span><a href="{{ route('brands.edit', $brand->id) }}"><span class="dropdown-items__link-icon">
