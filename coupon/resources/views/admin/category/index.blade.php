...
<!--                                    <form class="toolbox__search" method="GET">
                                ...
                                <div class="col-auto">
                                    <a class="button-add button-add--blue" href="{{ route('categorys.create') }}"><span class="button-add__icon">
                ...
                <div class="table-wrapper">
                    <div class="table-wrapper__content table-products table-collapse scrollbar-thin scrollbar-visible" data-simplebar>
                        <table class="table table--lines" id="categoryTable">
                            <thead class="table__header">
                                <tr class="table__header-row">
                                    <th class="table__th-sort"><span class="align-middle">Category Code</span><span class="sort sort--down"></span></th>
                                    <th class="table__th-sort"><span class="align-middle">Category Name</span><span class="sort sort--down"></span></th>
                            ...
                            <tbody>
                                ...
                                <tr class="table__row">
                                    ...
                                    <td class="table__td"><span>{{ $category->status==1?'Active':'Disabled' }}</span></td>
                                    <td class="table__td"><span><a href="{{ route('categorys.edit', $category->id) }}"><span class="dropdown-items__link-icon">
...
$('#categoryTable').DataTable(dataTableOptions);
</script>
