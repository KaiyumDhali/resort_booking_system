    ...
    <div class="container container--flex">
        ...
        <div class="card add-product card--content-center">
            <div class="card__wrapper">
                <div class="">
                    <form class="add-product__form" action="{{ route('units.update', $unit->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="">
                                ...
                                <div class="">
                                    <div class="col-12 form-group form-group--lg">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" type="text" name="unit_name" placeholder="" value="{{$unit->unit_name}}" required>
                                        </div>
                                    </div>
                                    <div class="col-12 form-group form-group--lg">
                                        <label class="form-label">Unit Value</label>
                                        <div class="input-group">
                                            <input class="form-control" type="text" name="unit_value" placeholder="" value="{{$unit->unit_value}}" required>
                                        </div>
                                    </div>
                                    <div class="col-12 form-group form-group--lg">
                                        ...
                                        <div class="input-group input-group--append">
                                            ...
                                            <select class="form-control" name="status" required>
                                                ...
                                                <option value="2" {{ $unit->status==2?'selected':'' }}>Disable</option>
                                            </select>
