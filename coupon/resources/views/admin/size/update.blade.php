            ...
            <div class="container container--flex">
                ...
                <div class="card add-product card--content-center">
                    <div class="card__wrapper">
                        <div class="">
                                <form class="add-product__form" action="{{ route('sizes.update', $size->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                <div class="">
                                        ...
                                        <div class="">
                                            <div class="col-12 form-group form-group--lg">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control" type="text" name="size_name" placeholder="" value="{{$size->size_name}}" required>
                                                </div>
                                            </div>
