        ...
        <main class="page-content">
            <div class="container">
                <div class="page-header">
                    <h1 class="page-header__title">Sizes</h1>
                </div>
                    ...
                    <div class="toolbox__row row gutter-bottom-xs">
                        ...
                        <div class="toolbox__right col-12 col-lg-auto">
                            <div class="toolbox__right-row row row--xs flex-nowrap">
                                ...
                                <div class="col-auto">
                                    <a class="button-add button-add--blue" href="{{ route('sizes.create') }}"><span class="button-add__icon">
                        ...
                        <table class="table table--lines">
                            <thead class="table__header">
                                <tr class="table__header-row">
                                    <th class="table__th-sort"><span class="align-middle">Size Name</span><span class="sort sort--down"></span>
                                    </th>
                            ...
                            <tbody>
                                ...
                                <tr class="table__row">
                                    <td class="table__td">{{$size->size_name}}</td>
                                    <td class="table__td"><span>{{ $size->status==1?'Active':'Disabled' }}</span>
                                    </td>
                                    <td class="table__td"><span><a href="{{ route('sizes.edit', $size->id) }}"><span class="dropdown-items__link-icon">
