<x-default-layout>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div class="card card-flush">
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        <a href="{{ route('spots.create') }}" class="btn btn-sm btn-primary">Add spot</a>
                    </div>
                </div>
                        ...
                        <tbody class="fw-semibold text-gray-700">
                            @forelse($spots as $spot)
                                <tr>
                                    ...
                                    <td><img src="{{ asset(Storage::url($spot->image)) }}" height="75"
                                            width="120" alt="Not Found" />
                                    </td>
                                    <td>
        @if($spot->facilities->count())
            @foreach($spot->facilities as $facility)
                <span class="badge badge-light-info me-1 mb-1">
                    {{ $facility->facility }}
                </span>
            @endforeach
        @else
        ...
        @endif
                                    ...
                                    <td>
                                        <span
                                            class="badge badge-light-{{ $spot->status == 1 ? 'success' : 'secondary' }}">
                                            {{ $spot->status == 1 ? 'Active' : 'Disable' }}
                                        </span>
                                    </td>
