...
<script type="text/javascript">
    ...
    function CallBack(pdfdata) {
        ...
        url =
            '{{ route('employees_search', ['employeeCode' => ':employeeCode', 'typeId' => ':typeId', 'departmentId' => ':departmentId', 'designationId' => ':designationId', 'pdf' => ':pdf']) }}';
                    ...
                    if (data.length > 0) {
                        ...
                        $.each(data, function(key, value) {
                            ...
                            table.row.add([d.employee_code, d.employee_name, d.type_name, d
                                .department_name, d.designation_name, action
                            ]).draw();
                        });
