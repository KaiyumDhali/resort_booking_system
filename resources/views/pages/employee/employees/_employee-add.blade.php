<x-default-layout>
    ...
    <!--begin::Content-->
    <div class="flex-lg-row-fluid pb-20">
        <!--begin:::Tabs-->
                                    ...
                                    <div class="col-12 col-md-3 me-lg-10">
                                        ...
                                        <div class="card card-flush py-4">
                                            {{-- <div class="card-body pt-0 pb-5">
                                                ...
                                                <select class="form-select form-select-sm" data-control="select2" id="changeBranch"
                                            ...
                                            {{-- <div class="card-body pt-0 pb-5">
                                                ...
                                                <select class="form-select form-select-sm" data-control="select2"
                                                    ...
                                                    <option selected value="">Select Employee Section</option>
                                            ...
                                            {{-- <div class="card-body pt-0 pb-5">
                                                ...
                                                <select class="form-select form-select-sm" data-control="select2"
                                                    ...
                                                    <option selected value="">Select Employee Line</option>
                                            ...
                                            {{-- <div class="card-body pt-0 pb-5">
                                                ...
                                                <select class="form-select form-select-sm" data-control="select2"
                                                    ...
                                                    <option selected value="">Select Employee Grade</option>
                                            ...
                                            {{-- <div class="card-body pt-0 pb-5">
                                                ...
                                                <select class="form-select form-select-sm" data-control="select2"
                                                    name="salary_section_id" required>
                                            ...
                                            <div class="card-body pt-5 pb-5">
                                                <div class="product fv-row fv-plugins-icon-container">
                                                    ...
                                                    <input type="date" name="joining_date"
                                                        ...
                                                        placeholder="Joining Date" value="" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="card-body pt-0 pb-2">
                                                        <div class="product fv-row fv-plugins-icon-container">
                                                            ...
                                                            <select class="form-select form-select-sm"
                                                                data-control="select2" name="gender" required>
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <div class="card-body pt-0 pb-2">
                                                        <div class="product fv-row fv-plugins-icon-container">
                                                            ...
                                                            <select class="form-select form-select-sm"
                                                                data-control="select2" name="marital_status">
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <div class="card-body pt-0 pb-2">
                                                        <div class="product fv-row fv-plugins-icon-container">
                                                            ...
                                                            <textarea name="present_address" class="form-control form-control-sm mb-2 expand-textarea"
                                                                placeholder="Present Address" rows="1"></textarea>
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <div class="card-body pt-0 pb-2">
                                                        <div class="product fv-row fv-plugins-icon-container">
                                                            ...
                                                            <textarea name="permanent_address" class="form-control form-control-sm mb-2 expand-textarea"
                                                                placeholder="Permanent Address" rows="1"></textarea>
                                                ...
                                                {{-- <div class="col-12 col-md-4">
                                                    <div class="card-body pt-0 pb-2">
                                                        <div class="product fv-row fv-plugins-icon-container">
                                                            ...
                                                            <select class="form-select form-select-sm"
                                                                data-control="select2" name="quite_type">
                                                                <option selected value="">Select Quit Type
                                                                </option>
                                                ...
                                                <div class="col-12 col-md-4">
                                                    <div class="card-body pt-0 pb-2">
                                                        <div class="product fv-row fv-plugins-icon-container">
                                                            ...
                                                            <select class="form-select form-select-sm"
                                                                data-control="select2" name="job_status" required>
                                                                <option selected value="">Select Job Status
                                                                </option>
                                                    ...
                                                    <div class="card-body py-5">
                                                        <div class="product fv-row fv-plugins-icon-container">
                                                            <label
                                                                ...
                                                                <span class="form-check-label text-muted fs-6">Active
                                                                </span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="product fv-row fv-plugins-icon-container">
                                                            <label
                                                                ...
                                                                <input class="form-check-input w-30px h-20px"
                                                                    ...
                                                                    name="salary_held_up" />
                                                                <span class="form-check-label text-muted fs-6">Salary
                                                                    Held up </span>
                                                            </label>
                                                        </div>
                                                    </div>
...
<script type="text/javascript">
    ...
    //     if (e.target.classList.contains('expand-textarea')) {
