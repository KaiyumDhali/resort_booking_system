                            ...
                            <div class="col-12 col-md-3 pe-lg-10">
                                ...
                                <div class="card card-flush pt-3">
                                    ...
                                    <div class="card-body pt-0 pb-5">
                                        ...
                                        <select class="form-select form-select-sm" data-control="select2" name="type_id"
                                            required>
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="card-body pt-0 pb-2">
                                                <div class="product fv-row fv-plugins-icon-container">
                                                    ...
                                                    <select class="form-select form-select-sm" data-control="select2"
                                                        name="job_status" required>
                                                        <option value=""
                                                            {{ $employee->job_status == 'Null' ? 'selected' : '' }}>Job
                                                            Status</option>
                                            ...
                                            <div class="card-body py-5">
                                                <div class="product fv-row fv-plugins-icon-container">
                                                    <label
                                                        class="form-check form-switch form-check-custom form-check-solid">
                                                        <input class="form-check-input w-30px h-20px" type="checkbox"
                                                            value="1" name="salary_held_up"
                                                            {{ $employee->salary_held_up == 1 ? 'checked' : '' }} />
                                                        <span class="form-check-label text-muted fs-6">Salary Held
                                                            up</span>
                                                    </label>
                                                </div>
                                            </div>
