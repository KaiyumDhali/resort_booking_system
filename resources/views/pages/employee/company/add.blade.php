            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div id="kt_app_content_container" class="app-container">
                    <form id="kt_ecommerce_add_category_form"
                        ...
                        action="{{ route('emp_company.store') }}" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Main column-->
                            ...
                            <div class="card card-flush py-4">
                                <div class="row">
                                        ...
                                        <div class="card-body pt-0 pb-2">
                                            <div class="fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="proprietor_name" class="form-control form-control-sm mb-2"
                                                    placeholder="Proprietor Name" value="" >
                                        ...
                                        <div class="card-body pt-0 pb-2">
                                            <div class="fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="company_details" class="form-control form-control-sm mb-2"
                                                    placeholder="Company Details" value="">
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body pt-0 pb-2">
                                            <div class="fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="factory_address" class="form-control form-control-sm mb-2"
                                                    placeholder="Factory Address" value="">
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="card-body pt-0 pb-2">
                                            <div class="fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="email" name="company_email" class="form-control form-control-sm mb-2"
                                        ...
                                        <div class="card-body pt-0 pb-2">
                                            <div class="fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="trade_license" class="form-control form-control-sm mb-2"
                                                    placeholder=" Trade License No" value="">
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="card-body pt-0 pb-2">
                                            <div class="fv-row fv-plugins-icon-container">
                                                <label class="required form-label">Default Left Menu Logo (170px X 60px)</label>
                                                <input type="file" name="company_logo_one" class="form-control form-control-sm mb-2"
                                                    placeholder=" Default Left Menu Logo" value="" required>
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="card-body pt-0 pb-2">
                                            <div class="fv-row fv-plugins-icon-container">
                                                <label class="required form-label"> Default Left Small Menu Logo (80px X 70px)</label>
                                                <input type="file" name="company_logo_two" class="form-control form-control-sm mb-2"
                                                    placeholder=" Default Left Small Menu Logo" value="" required>
                                                <div class="fv-plugins-message-container invalid-feedback"></div>
                                            </div>
                                        </div>
                                    </div>
                                   ...
                                   @can('edit discount limit')
                                        ...
                                        <div class="card-body pt-0 pb-2">
                                            <div class="fv-row">
                                                ...
                                                <input type="number"
                                                    ...
                                                    value="{{ old('discount_limit', $companySetting->discount_limit ?? 5) }}"
                                                    min="0"
                                                    max="100">
                                                <small class="text-muted">
                                                    Maximum discount allowed for bookings
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    @can('edit multiple spot discount limit')
                                    <div class="col-12 col-md-6">
                                        <div class="card-body pt-0 pb-2">
                                            <div class="fv-row">
                                                <label class="form-label fw-bold">
                                                    Multiple Spots Discount Limit (%)
                                                </label>
                                                <input type="number"
                                                    name="multiple_spot_discount_limit"
                                                    class="form-control form-control-sm"
                                                    value="{{ old('multiple_spot_discount_limit', $companySetting->multiple_spot_discount_limit ?? 5) }}"
                                                    min="0"
                                                    max="100">
                                                <small class="text-muted">
                                                    Maximum discount allowed for bookings
