...
<p class="text-justify">
    এই মর্মে জানানো যাচ্ছে যে, আমাদের প্রতিষ্ঠান "ওয়ান্ডার পার্ক এন্ড ইকো রিসোর্ট" এর প্রয়োজনীয়তার ভিত্তিতে <strong>{{ $workOrder->client->company ?? 'N/A' }}</strong> এর নিকট নিম্নলিখিত কাজটি সম্পন্ন করার জন্য কার্যাদেশ প্রদান করছে।
