...
@section('content')
    <style>
        ...
        .cta-section::after {
            ...
            /* Blur only around 50px edges */
            box-shadow: 0 0 500px 50px rgba(0, 0, 0, 0.7) inset;
            border-radius: inherit;
        }

        .cta-section .auto-container,
        .cta-section .offer-image {
            position: relative;
            z-index: 2;
            /* keep text/content visible above blur */
        }
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="content-block">
                        ...
                        <div class="link-btn" >
                            <a href="{{ route('frontend.about') }}" class="theme-btn btn-style-two btn-lg" style="margin-top: 30px!important;"><span>discover
                ...
                <div class="col-lg-6">
                    <div class="image img_hover_3">
                        ...
                        <img src="{{ asset('storage/images/home/Untitled-1.jpg') }}" alt="" style="border: 8px solid #fff;" />
                    </div>
                </div>
            </div>
        </div>
